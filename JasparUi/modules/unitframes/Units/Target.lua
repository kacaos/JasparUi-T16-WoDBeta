...
hooksecurefunc(TukuiUnitFrames, "Target", function(Target)
	...
	Target.Debuffs:Point("BOTTOMLEFT", Target.Buffs, "TOPLEFT", 0, 3)
	Target.Debuffs:SetWidth(204)

	Target.Buffs:SetWidth(204)	
